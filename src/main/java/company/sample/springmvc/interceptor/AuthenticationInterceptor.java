package company.sample.springmvc.interceptor;
...
import company.sample.common.CommonLogContent;
import company.sample.common.CommonMessageContent;
import company.sample.common.SystemDefaultProperties;
...
public class AuthenticationInterceptor implements HandlerInterceptor
{
     ...
     *
     * @param username   user ID  default "rugal"
     * @param credential user password default "123456"
     *
     *
    ...
    {
        return StringUtils.equals(username, "id") && StringUtils.equals(credential, "credential");
    }
